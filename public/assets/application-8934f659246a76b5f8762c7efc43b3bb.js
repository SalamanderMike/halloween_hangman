...
(function() {
  var GameControllers, GameCtrl, ModalControls,
  ...
  GameCtrl = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          if (character === object.chr) {
            this.secretDisplay.push(object);
          }
        }
      }
    ...
    GameCtrl.prototype.wrongChoice = function() {
      console.log("WRONG CHOICE");
      this.wrong = true;
      return this.timeout(((function(_this) {
        return function() {
          return _this.wrong = false;
        };
      })(this)), 200);
    };
    ...
    GameCtrl.prototype.showGhostPieces = function() {
      switch (this.lose) {
        ...
        case 2:
          return this.visibleTwo = true;
        case 3:
          return this.visibleThree = true;
        case 4:
          return this.visibleFour = true;
        case 5:
          return this.visibleFive = true;
        case 6:
    ...
    GameCtrl.prototype.secretWindow = function(size) {
      ...
      return modalInstance.result.then((function(_this) {
        return function(secretPhrase) {
          _this.secretPhrase = secretPhrase;
          if (_this.secretPhrase.length > 1) {
            return _this.makeSecretWord(secretPhrase);
          }
        };
      })(this), function() {
  ...
  ModalControls = (function() {
    function ModalControls(scope, modalInstance) {
      this.scope = scope;
    ...
    ModalControls.prototype.cancel = function() {
      console.log("CANCEL");
      return this.modalInstance.dismiss("canceled");
    };

    ModalControls.prototype.play = function() {
      return this.modalInstance.close(this.secretPhrase);
    };

    ModalControls.prototype.hitEnter = function(evt) {
      if (angular.equals(evt.keyCode, 13) && !(angular.equals(this.secretPhrase, null) || angular.equals(this.secretPhrase, ""))) {
        return this.play();
      }
    };
...
(function() {
  var GameFactories, ModalControls;

  GameFactories = angular.module("GameFactories", []);

  ModalControls = (function() {
    function ModalControls(scope, modal, modalInstance) {
      this.scope = scope;
      this.modal = modal;
      this.modalInstance = modalInstance;
...
(function() {
  ...
  GameRouter = angular.module("GameRouter", ["ngRoute"]);

  GameRouter.config(["$routeProvider", "$locationProvider", Router]);

}).call(this);
(function() {
  angular.module("GameApp", ["GameRouter", "GameControllers", "GameFactories"]);
